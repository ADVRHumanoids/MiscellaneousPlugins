...
#ifndef __MISC_PLUGINS_ROS_CirclePublisher_PLUGIN_H__
#define __MISC_PLUGINS_ROS_CirclePublisher_PLUGIN_H__
...
class CirclePublisher : public XBot::XBotControlPlugin {
